...
bool EEex::Menu_LuaHook_BeforeListRenderingItem_Enabled;
...
CString::type_MakeUpper CString::p_MakeUpper;
...
type_SDL_GL_SetSwapInterval p_SDL_GL_SetSwapInterval;
...
type_BGGetPrivateProfileInt p_BGGetPrivateProfileInt;
...
C2DArray::type_GetAtCStringLabels C2DArray::p_GetAtCStringLabels;
...
CChitin::type_GetVersionString_Internal CChitin::p_GetVersionString_Internal;
CChitin::type_ParseCommandLine CChitin::p_ParseCommandLine;
CChitin::type_ProcessEvents CChitin::p_ProcessEvents;
CChitin::type_Update CChitin::p_Update;
...
CAIObjectType::type_Equals CAIObjectType::p_Equals;
CAIObjectType* CAIObjectType::p_NOONE;
CAIObjectType* CAIObjectType::p_ANYONE;
...
void InitBindingsInternal() {
	...
	attemptFillPointer(TEXT("CString::MakeUpper"), CString::p_MakeUpper);
	...
	attemptFillPointer(TEXT("SDL_GL_SetSwapInterval"), p_SDL_GL_SetSwapInterval);
	...
	attemptFillPointer(TEXT("BGGetPrivateProfileInt"), p_BGGetPrivateProfileInt);
	...
	attemptFillPointer(TEXT("d3d"), p_d3d);
	...
	attemptFillPointer(TEXT("C2DArray::GetAt(const CString*,const CString*)"), C2DArray::p_GetAtCStringLabels);
	...
	attemptFillPointer(TEXT("CChitin::GetVersionString"), CChitin::p_GetVersionString_Internal);
	attemptFillPointer(TEXT("CChitin::ParseCommandLine"), CChitin::p_ParseCommandLine);
	attemptFillPointer(TEXT("CChitin::ProcessEvents"), CChitin::p_ProcessEvents);
	attemptFillPointer(TEXT("CChitin::Update"), CChitin::p_Update);
	...
	attemptFillPointer(TEXT("CAIObjectType::operator=="), CAIObjectType::p_Equals);
	attemptFillPointer(TEXT("CAIObjectType::NOONE"), CAIObjectType::p_NOONE);
	attemptFillPointer(TEXT("CAIObjectType::ANYONE"), CAIObjectType::p_ANYONE);
